...
class NetworkInterface {
  private:
    ...
    std::map<size_t, ARP_Entry> _arp_table;
    size_t _arp_entry_default_ttl;
    std::map<size_t, size_t> _waiting_arp_response_ip_addr;
    size_t _arp_response_default_ttl;
    std::list<std::pair<Address, InternetDatagram>> _waiting_arp_internet_datagram;
